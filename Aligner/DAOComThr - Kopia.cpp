...
int DAOComThread::InitUSBHW()
{
	...
	m_ftd2Api.ResetDevice();
	m_ftd2Api.SetTimeouts(3000, 3000);//extend timeout while board DLP-USB2 finishes reset
	m_ftd2Api.Purge(FT_PURGE_RX || FT_PURGE_TX);
...
{    
    ...
    m_comPort = reg.GetStringValue("DAUPort", "");
