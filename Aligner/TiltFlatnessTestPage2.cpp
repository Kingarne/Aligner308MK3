// $Id: TiltFlatnessTestPage2.cpp,v 1.4 2013/04/26 14:41:36 riar Exp $
//
...
IMPLEMENT_DYNAMIC(CTiltFlatnessTestPage2, CPropertyPage)

CTiltFlatnessTestPage2::CTiltFlatnessTestPage2()
	: CPropertyPage(CTiltFlatnessTestPage2::IDD)
{
}
...
void CTiltFlatnessTestPage2::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CTiltFlatnessTestPage2, CPropertyPage)
END_MESSAGE_MAP()

// CTiltFlatnessTestPage2 message handlers

BOOL CTiltFlatnessTestPage2::OnInitDialog()
{
...
BOOL CTiltFlatnessTestPage2::OnSetActive() 
{
  if( m_pParent == NULL )
  {
...
BOOL CTiltFlatnessTestPage2::OnQueryCancel()
{
...
LRESULT CTiltFlatnessTestPage2::OnWizardBack() 
{
   return CPropertyPage::OnWizardBack();
}

LRESULT CTiltFlatnessTestPage2::OnWizardNext()
{
...
void CTiltFlatnessTestPage2::OnReset()
{
...
void CTiltFlatnessTestPage2::InitMeasureParam()
{
